...
const DeleteMember = () => {
     ...
     const handleDeleteMember = async () => {
          ...
          try {
               socket?.deleteMember(groupId, checkedList);
          ...
          <View>
               {
                    currentConversation?.group?.members?.map((member) => {
                         ...
                         return <Contact isSelect={true} isSelected={checkedList} key={member?.userId} name={member?.user?.name} id={member?.userId} onCheck={handleCheck}>
